...
# from models.dense_att_cy_ed import DenseED
...
# Data path! change the path !!!!!!!! ==============================================================
train_data_dir = '/home/hongbo/UWB_Fi_python/data/trainData.mat'
test_data_dir = '/home/hongbo/UWB_Fi_python/data/testData.mat'
# !!!!!!!!!!========================================================================================

# initialize model
model = DenseED(in_channels=4, out_channels=1, 
                blocks=(3,6,3),
...
train_loader, train_stats = load_data(train_data_dir, args.batch_size,True)
test_loader, test_stats = load_data(test_data_dir, args.test_batch_size,False)
print('Loaded data!')
