...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        ...
        # network
        self.add_argument('--blocks', type=list, default=[3, 3, 3], help='list of number of layers in each dense block')
        ...
        self.add_argument('--ntrain', type=int, default=380, help="number of training data")
        self.add_argument('--ntest', type=int, default=20, help="number of test data") 

        # training
        self.add_argument('--epochs', type=int, default=200, help='number of epochs to train (default: 200)')   # 300
        ...
        self.add_argument('--test-batch-size', type=int, default=8, help='input batch size for testing (default: 100)')
        ...
        self.add_argument('--ckpt-freq', type=int, default=100, help='how many epochs to wait before saving model')   # 100
        self.add_argument('--log-freq', type=int, default=1, help='how many epochs to wait before logging training status')
        self.add_argument('--plot-freq', type=int, default=500, help='how many epochs to wait before plotting test output')   # 300
