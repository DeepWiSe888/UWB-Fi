...
0. **Fast Channel Hopping Scheme**: Unzip *PicoScenes-PDK-modified.zip* and follow the instructions in [this link](https://ps.zpj.io/manual/plugin.html) to install it, enabling the collection of discrete channel samples. You can also use our dataset to test this demo.
